                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                      <h1 class='h3  text-center' style='padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;' align='center'>Hey, ".$_SESSION['name']." interacted with you !</h1>
                                                      ...
                                                      <h5 class='text-teal-700 text-center' style='color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;' align='center'>".$_SESSION['subject']."</h5>
                                                      ...
                                                      <div class='space-y-3 text-center' style=' align='center'>
                                                        <p class='text-center' style='line-height: 24px; font-size: 16px; width: 100%; margin: 0;' align='center'> Contact <a href='mailto://".$_SESSION['mail']."' style='text-transform: uppercase; color: #0d6efd;'>".$_SESSION['name']."</a> !</p>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                </tbody>
